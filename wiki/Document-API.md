...
> **Tip: File Size Limit** - Maximum file size: 50MB. Larger files should be split or hosted externally.

> **Warning: Permissions** - Document areas can require specific permissions. Users without required permission cannot see those areas.
