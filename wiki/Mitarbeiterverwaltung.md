...
**Abteilung entfernen:**
- Klicken Sie auf das X neben der Abteilung
...
Detaillierte Informationen zur Admin-Konfiguration des Mitarbeitermoduls finden Sie unter `/admin/employees`. Dort können Abteilungen, Dienstgrade, Lizenztypen, Mitarbeiternummernformate, benutzerdefinierte Felder, Statustypen, Benachrichtigungseinstellungen, Import-/Export-Konfiguration, Integrationseinstellungen, Berichtskonfiguration und Systemeinstellungen verwaltet werden.
