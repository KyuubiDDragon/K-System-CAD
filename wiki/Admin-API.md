...
Administrative API for managing user accounts, roles, and permissions in K-Systems.
...
All role and user operations respect authority boundaries for multi-tenant isolation.
