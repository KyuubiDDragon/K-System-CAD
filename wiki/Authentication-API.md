...
- [[Employee-API]] - Employee management endpoints
- [[Report-API]] - Report system endpoints
- [[Document-API]] - Document management endpoints
- [[Admin-API]] - User administration endpoints

---

> **Tip: Token Security** - Always use HttpOnly cookies in production for maximum security against XSS attacks.

> **Warning: HTTPS Required** - In production, always use HTTPS. Tokens sent over HTTP can be intercepted.

> **Info: Token Refresh** - Tokens automatically refresh when less than 1 hour remains. No action needed on frontend.
