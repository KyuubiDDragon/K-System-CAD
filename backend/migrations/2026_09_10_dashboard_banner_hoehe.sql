...
-- Datum: 2026-09-10
--
-- Der Baustein zeigt eine Begruessung, das Datum und ein Namenskuerzel, also
-- eine Zeile Text. Die Vorlage "employee" gab ihm dafuer sechs Rasterzeilen,
...
-- durchgehend Platzhalter. Inzwischen ist sie ausgeblendet, die reservierte
...
--
-- ACHTUNG fuer kuenftige Migrationen: run_migrations.php zerlegt die Datei mit
-- explode auf das Semikolon, bevor irgendetwas ausgewertet wird. Ein Semikolon
-- in einem Kommentar zerschneidet damit die Anweisung dahinter. Genau daran ist
-- die erste Fassung dieser Migration gescheitert, ohne dass der Lauf es meldete.
