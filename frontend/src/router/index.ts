...
const routes: Array<RouteRecordRaw> = [
    ...
    { path: '/social-platform', name: 'social-platform', component: () => import('@/views/SocialView.vue'), meta: { requiresAuth: true }},
    { path: '/laws-editor', name: 'laws-editor', component: () => import('@/views/LawsEditorView.vue'), meta: { requiresAuth: true }},
