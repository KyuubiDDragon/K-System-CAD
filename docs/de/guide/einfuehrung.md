...
1. [🚀 Schnellstartanleitung](/de/guide/erste-schritte) - K-Systems zum Laufen bringen
2. [🏗️ Architekturübersicht](/de/architecture/uebersicht) - System verstehen
3. [👨‍💻 Entwicklerhandbuch](/developer/setup) - Mit der Entwicklung beginnen
4. [🚢 Deployment-Leitfaden](/deployment/docker) - In Produktion deployen

---

::: tip Bereit zu starten?
Fahren Sie mit der [Erste-Schritte-Anleitung](/de/guide/erste-schritte) fort, um K-Systems zu installieren und auszuführen.
:::
