...
## Employee ID {#employee-id-validation}
- Optional field
...
- [Training API](/api/training) - Employee training and certifications
- [Vacation API](/api/vacation) - Employee vacation management
- [Report API](/api/report) - Link employees to reports
- [Admin User API](/api/admin/user) - User account management

---

::: tip Multi-Tenant Isolation
All employee queries automatically filter by authority_id. You can never access employees from other authorities.
:::

::: warning Soft Delete
Deleted employees are marked as deleted but not removed from database. This preserves historical data and report associations.
:::
