...
## Connect with Authentication {#connect}
...
## Whiteboard Namespace {#whiteboard}
...
Socket connections are automatically maintained. If disconnected, auto-reconnect occurs with exponential backoff.
:::

::: warning Production Use
Always use WSS (WebSocket Secure) in production. Never send tokens over unencrypted connections.
:::
