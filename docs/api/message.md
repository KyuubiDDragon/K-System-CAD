...
::: tip Real-time Messages
Messages are delivered in real-time via WebSocket. Use Socket API for instant message notifications.
:::

::: info Message Search
Use global search API to search message content and participants.
:::
